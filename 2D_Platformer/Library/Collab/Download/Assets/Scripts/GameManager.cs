...
public class GameManager : MonoBehaviour
{
    ...
    public void SetCurrentPlayer(CharacterSelection character)
    {
        string path = Application.persistentDataPath + "/Character.dat";
        if (File.Exists(path))
        {
            File.WriteAllLines(path, new string[] { character.name });
        }
    }
    ...
    {
        string path = Application.persistentDataPath + "/Unlocables.dat";
        SetCurrentPlayer(GetCharacter("Standard"));
        File.Delete(path);
        SetupUnlocables();
    }
    ...
    public void UpdatePlayer()
    {
        ...
        {
            File.Create(path).Close();
            File.WriteAllLines(path, new string[] { "Standard" });
        }
    }
